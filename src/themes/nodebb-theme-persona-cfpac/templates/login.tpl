			...
			<form class="form-horizontal" role="form" method="post" id="login-form">
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						...
						<span class="login__no-acct--txt">[[login:dont_have_account]] <a id="login__no-acct" class="btn btn-primary btn-lg btn-block" href="{config.relative_path}/register">[[register:register]]</a></span>
